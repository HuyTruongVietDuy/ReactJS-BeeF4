...
></iframe>
              ...
              <div className="box-right">
                <div className="box-right-0 box-right-1">
                  <i className="material-icons">location_on</i>
                  Địa chỉ của chúng tôi
                  <p><a href="#/">Công viên Quan Trung, Quận 12, TP .HCM</a></p>
                </div>
                <div className="box-right-0 box-right-2">
                  <i className="material-icons">email</i>
                  Email
                  <p><a href="#/">SQ&BE@gmail.com</a></p>
                </div>
                <div className="box-right-0 box-right-3">
                  <i className="material-icons">phone</i>
                  Số điện thoại
                  <p><a href="#/">012345678</a></p>
                </div>
                <div className="box-right-0 box-right-4">
                  <i className="material-icons">video_call</i>
                  Tiktok
                  <p><a href="#/">https://www.tiktok.com/@huy_not_rotws</a></p>
                </div>
                <div className="box-right-0 box-right-5">
                  <i className="material-icons">facebook</i>
                  Fanpage
                  <p><a href="#/">https://www.tiktok.com/@huy_not_rotws</a></p>
                </div>
                <div className="box-right-0 box-right-6">
